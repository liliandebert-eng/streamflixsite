export default function StreamFlixStore() {
  const products = [
    {
      ...
      stock: 24,
      description:
        'Compte Premium UHD avec accès instantané, profils multi-utilisateurs et streaming illimité.',
    ...
    },
    {
      ...
      stock: 18,
      description:
        'Profitez des films Marvel, Star Wars et Disney en qualité 4K sans publicité.',
    ...
    },
    {
      ...
      stock: 11,
      description:
        'Streaming premium Paramount+ avec accès rapide et garantie incluse.',
    ...
    },
    {
      ...
      stock: 0,
      description:
        'Navigation sans publicité, lecture en arrière-plan et YouTube Music inclus.',
    ...
    },
    {
      ...
      stock: 14,
      description:
        'Accès Prime Video UHD avec catalogue exclusif et livraison instantanée.',
    ...
    },
    {
      ...
      stock: 31,
      description:
        'Musique illimitée, mode hors ligne et audio haute qualité sans publicité.',
  ...
  return (
    <div className="min-h-screen bg-[#0B0B0F] text-white overflow-hidden">
      {/* <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(229,9,20,0.15),transparent_35%)] pointer-events-none" /> */}
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl border-b border-white/10 bg-black/40">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4 gap-4">
          <a href="/" className="flex items-center gap-3 hover:opacity-90 transition-opacity">
            <div className="w-11 h-11 rounded-2xl bg-white shadow-[0_0_30px_rgba(229,9,20,0.5)] flex items-center justify-center overflow-hidden p-1">
              <img
          ...
          <div className="flex items-center gap-3">
            <button className="px-5 py-2 rounded-xl border border-white/10 hover:border-red-500 transition-all bg-white/5">
              Connexion
            </button>
            <button className="px-5 py-2 rounded-xl bg-red-600 hover:bg-red-500 transition-all shadow-[0_0_25px_rgba(229,9,20,0.5)]">
              🛒 Panier
            </button>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-5 py-8 grid lg:grid-cols-[360px_1fr] gap-8 relative z-10">
        <section className="space-y-6">
          <div>
            <div className="space-y-4 max-h-[760px] overflow-auto pr-2 custom-scroll pt-8 -mt-5">
              {products.map((item, index) => (
                ...
                >
                  <div className={`absolute inset-0 opacity-5 bg-gradient-to-br ${item.accent}`} />

                  <div className="relative flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 rounded-2xl bg-black/60 border border-white/10 flex items-center justify-center text-2xl font-black group-hover:scale-105 transition-transform">
                        {item.logo}
                      </div>
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="px-2 py-1 rounded-full bg-yellow-500/20 text-yellow-300 text-xs border border-yellow-500/20">
                            ✦ Premium
                          </span>
                        </div>
          ...
          <div className="rounded-3xl bg-gradient-to-br from-zinc-900 to-black border border-white/10 p-6 shadow-2xl overflow-hidden relative">
            ...
            <div className="space-y-4 relative z-10">
              {products.slice(0, 3).map((item, i) => (
                <div
                  key={item.name}
                  className="flex items-center justify-between rounded-2xl bg-white/5 border border-white/5 p-4 hover:bg-white/10 transition-all"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-red-600/20 flex items-center justify-center font-bold">
                      {item.logo}
                    </div>
                    <div>
                      <p className="font-medium">{item.name}</p>
                      <p className="text-sm text-zinc-400">#{i + 1} meilleure vente</p>
                    </div>
                  </div>
        ...
        <section className="space-y-8">
          <div className="relative rounded-[36px] overflow-hidden border border-white/10 bg-gradient-to-br from-zinc-900 via-black to-zinc-900 shadow-[0_0_60px_rgba(0,0,0,0.8)] p-8 lg:p-10">
            <div className={`absolute inset-0 opacity-10 bg-gradient-to-br ${selected.accent}`} />
            ...
            <div className="relative z-10 flex flex-col xl:flex-row gap-10 justify-between">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-5 mb-6">
                  <div className="w-24 h-24 rounded-3xl bg-black/50 border border-white/10 flex items-center justify-center text-5xl font-black shadow-inner">
                    {selected.logo}
                  </div>

                  <div>
                    <h2 className="text-4xl font-black tracking-wide">{selected.name}</h2>
                    <p className="text-zinc-400 mt-2">Compte streaming premium instantané</p>
                  </div>
                </div>
              ...
              <div className="xl:w-[360px]">
                <div className="rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl p-6 shadow-2xl sticky top-28">
                  ...
                  <div className="space-y-4">
                    <button className="w-full py-4 rounded-2xl bg-red-600 hover:bg-red-500 transition-all font-bold text-lg shadow-[0_0_30px_rgba(229,9,20,0.5)] hover:scale-[1.02]">
                      Acheter maintenant
                    </button>

                    <button className="w-full py-4 rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 transition-all font-semibold hover:border-red-500/40">
                      Ajouter au panier
                    </button>
                  </div>
                  ...
                  <div className="mt-8 pt-6 border-t border-white/10 space-y-4">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-green-400">Instantanée</span>
                    </div>
      ...
      <footer className="border-t border-white/10 mt-16 bg-black/40 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div>
            ...
            <p className="text-zinc-500 text-sm mt-1">© 2026 Premium Streaming Marketplace</p>
          </div>

          <div className="flex items-center gap-6 text-zinc-400 text-sm">
            <button className="hover:text-red-400 transition-colors">Conditions</button>
            <button className="hover:text-red-400 transition-colors">Support</button>
            <button className="hover:text-red-400 transition-colors">FAQ</button>
          </div>
        </div>
      </footer>
